    ...
    return (
        <PageLayout activeTab="shop">
            <div className="max-w-6xl mx-auto py-6 md:py-12 px-4 sm:px-6 lg:px-8">
                {/* Hero Header */}
                <div className="relative mb-8 md:mb-20 text-center">
                    <motion.div
                    ...
                    >
                        ...
                        <h1 className="text-3xl sm:text-4xl md:text-7xl font-black text-slate-900 dark:text-white tracking-tighter italic uppercase">
                            CRYSTAL <span className="text-primary border-b-2 md:border-b-8 border-primary/20">FORGE</span>
                        </h1>
                        <p className="text-base md:text-xl text-slate-500 font-bold max-w-2xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                    {CRYSTAL_ITEMS.map((item, idx) => (
                        ...
                        >
                            <Card
                                className={`h-full p-4 md:p-8 flex flex-col items-center text-center relative overflow-hidden group border-2 hover:border-primary/30 transition-all duration-500 ${item.glow}`}
                            >
                                ...
                                <div className={`size-16 md:size-24 rounded-2xl md:rounded-[2.5rem] bg-slate-50 dark:bg-slate-800/50 flex items-center justify-center mb-4 md:mb-8 group-hover:rotate-12 transition-transform duration-500 relative`}>
                                    <Icon name={item.icon} size={32} mdSize={48} className={item.color} filled />
                                    <div className={`absolute inset-0 rounded-2xl md:rounded-[2.5rem] ${item.color.replace('text', 'bg')}/10 animate-pulse`}></div>
                                </div>

                                <div className="space-y-1 md:space-y-3 flex-1 mb-4 md:mb-8 min-w-0 w-full">
                                    ...
                                    <p className="text-slate-500 font-bold text-[10px] md:text-sm leading-relaxed px-2">
                                        {item.description}
                                    </p>
                                </div>
                ...
                <div className="mt-12 md:mt-32 p-6 md:p-12 rounded-[2rem] md:rounded-[4rem] bg-slate-900 text-white relative overflow-hidden">
